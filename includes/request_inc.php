...
if(isset($_POST['submit_btn']))
{
    ...
    {   
        ...
        <a href='http://localhost/VacationPortal/php/accept_request.php?user_email=$email'>click here to approve the application</a> <br>
        <a href='http://localhost/VacationPortal/php/main_employee.php'>click here to reject the application</a>";
